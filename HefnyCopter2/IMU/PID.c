...
//float PID_Calculate_ACC (const pid_param_t PID_Params, pid_terms_t *PID_Term, const double  Value, const double PDiv, const double IDiv, const double DDiv)
//{
	//#define ACC_I_MIN	4
		//
	//float Output;
...
const float PIDFactors[2][3]= {{20.0,200.0,20.0}, {10.0,100.0,20.0}};
