...
{
	char s[7];
	utoa(ADCPort_Get(GYRO_X_PNUM), s, 10);
	lcdSetPos(0, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
	utoa(ADCPort_Get(GYRO_Y_PNUM), s, 10);
	lcdSetPos(1, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
	utoa(ADCPort_Get(GYRO_Z_PNUM), s, 10);
	lcdSetPos(2, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
	
	utoa(ADCPort_Get(ACC_X_PNUM), s, 10);
	lcdSetPos(3, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
	utoa(ADCPort_Get(ACC_Y_PNUM), s, 10);
	lcdSetPos(4, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
	utoa(ADCPort_Get(ACC_Z_PNUM), s, 10);
	lcdSetPos(5, 48);
	lcdWriteString(s);
	lcdWriteChar(32);
