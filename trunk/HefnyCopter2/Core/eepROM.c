...
static config_t const defaultConfig PROGMEM = 
{
	...
	.StickScaling = 4,
	.LVA = 0,
	.AccParams[0] ={15,90,0,0,-2,30,600},		// ACC_X & Y
	.AccParams[1] ={0,0,0,0,0,0,600},			// ACC_Z
