...
static config_t const defaultConfig PROGMEM = 
{
	...
	.GyroParams[0] = {27,100,0,0,-1,20,0},	// pitch roll gyro.
	.GyroParams[1] = {10,50,1,45,0,20,200},	// Yaw gyro
	.AccParams[0]  = {6,50,1,20,2,50,990},		// ACC_PITCH & Y
	.AccParams[1]  = {0,35,0,35,0,45,600},	// ACC_Z
	.SonarParams[0] ={0,35,192,15,37,45,600},
