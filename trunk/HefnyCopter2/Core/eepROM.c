...
static config_t const defaultConfig PROGMEM = 
{
	...
	.GyroParams[0] = {25,100,0,0,-3,20,0},	// pitch roll gyro.
	.GyroParams[1] = {50,90,50,40,0,20,200},	// Yaw gyro
	.AccParams[0]  = {10,90,20,15,2,50,990},		// ACC_PITCH & Y
	.AccParams[1]  = {10,35,0,35,0,45,600},	// ACC_Z
	.SonarParams[0] ={0,35,192,20,60,45,600},
